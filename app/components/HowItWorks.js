...
const steps = [
  {
    ...
    desc: 'Заполните форму ниже — мы свяжемся и настроим отдельного бота специально для вашей компании.',
  },
  {
    num: '02',
    icon: '⚡',
    title: 'Получаете своего бота и добавляете сотрудников',
    desc: 'Вы получаете персонального Telegram-бота. Сотрудники пишут ему — вы одобряете заявки одним нажатием.',
  },
  {
    num: '03',
    icon: '📅',
